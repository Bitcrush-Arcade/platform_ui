...
type ContextType = {
  ...
  tokenInfo: { weiBalance: BigNumber, crushUsdPrice: number, burned: number, niceUsdPrice: number },
...
export const TransactionContext = createContext<ContextType>({
  ...
  completed: {},
  editTransactions: () => { },
  tokenInfo: { weiBalance: new BigNumber(0), crushUsdPrice: 0, niceUsdPrice: 0, burned: 0 },
  toggleDarkMode: () => { },
  isDark: true,
...
export const TransactionLoadingContext = (props: { children: ReactNode, emotionCache: EmotionCache }) =>
{
  ...
  const [ coinInfo, setCoinInfo ] = useImmer<ContextType[ "tokenInfo" ]>({ weiBalance: new BigNumber(0), crushUsdPrice: 0, niceUsdPrice: 0, burned: 0 })
  ...
  const getTokenInfo = useCallback(async () =>
  {
    ...
    setCoinInfo(draft =>
    {
      ...
      draft.niceUsdPrice = +crushPrice?.niceUsdPrice || 0
    })
    tokenHydration()
