...
const styles = (theme:Theme) => createStyles({
  root:{
    ...
    background: (props: CardStyles ) => styledBy<CardStyles, BackgroundMapping>('background',{
        ...
        light: `linear-gradient(54deg, ${theme.palette.background[theme.palette.type == 'dark' ? 'default' : 'paper']} 0%,${theme.palette.background[theme.palette.type == 'dark' ? 'default' : 'paper']} 10%, ${theme.palette.background.paper} 75%, ${theme.palette.background.paper} 100%)`,
