...
async function calcSell(tokensToSell: number, tokenAddres: string)
{
  ...
  for (let i = 0; i < routerContract.length; i++) {
    try {
      let router = await new web3.eth.Contract(pancakeSwapAbi, routerContract[ i ]);
