...
const BridgeCard = (props: BridgeCardProps) => {
  ...
  return <div className="flex flex-col gap-10 border-2 border-secondary box-highlight-secondary bg-paper-bg px-8 pt-1 pb-10 rounded-[32px] max-w-[500px] text-white">
          ...
          <div className="flex flex-col justify-items-center items-center gap-3">
            ...
            <h3 className="text-white text-[1.5rem] font-bold mt-6">
                BRIDGE TOKEN
            </h3>
            ...
            <div className="flex justify-center">
              {
                ...
                :
                <button className="flex flex-row items-center gap-2 border-2 border-primary inner-glow-primary mt-10 px-6 py-4 text-xs rounded-full hover:bg-primary hover:text-black" onClick={login}>
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
